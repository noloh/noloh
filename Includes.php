...
require('Controls/Core/CheckControl.php');
...
require('Controls/Core/Multimedia.php');
...
require('Controls/Extended/TabPanel.php');
require('Controls/Extended/TransferPanel.php');
